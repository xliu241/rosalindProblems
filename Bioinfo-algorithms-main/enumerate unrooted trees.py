...
#rooted -> unrooted
species = 'Actitis_indica Asthenodipsas_subglobosa Elseya_macrops Heteroscodra_Anas Leiopython_mutabilis Lystrophis_canagica Notophthalmus_botnica'.split()
for tree in enum_unordered(species): 
    if str(tree).split(' ')[0] == '(Actitis_indica':
        print("(" + str(tree)[16:-1].replace(' ',',') + ")Actitis_indica;")
